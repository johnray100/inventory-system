...
export default function InvoiceCreate() {
    ...
    const [items, setItems] = useState([{ name: "", price: 0, units: 1, total: 0 }]);
        ...
        <Box sx={{ p: 3 }}>
            ...
            >
                <Box>
                    ...
                    <Breadcrumbs aria-label="breadcrumb" sx={{ fontSize: 14 }}>
                        ...
                        <Typography color="text.primary">Invoice Create</Typography>
                    </Breadcrumbs>
                </Box>
                <Box sx={{ 
                    position: "absolute", 
            ...
            <Paper sx={{ p: { xs: 3, md: 5 }, borderRadius: 4, boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 4, flexWrap: "wrap", gap: 2 }}>
                    <Typography variant="h6" fontWeight="bold" color="text.primary"># 108</Typography>
                ...
                <Grid container spacing={3} sx={{ mb: 5 }}>
                    ...
                    <Grid item xs={12} md={6}>
                        <TextField fullWidth label="Bill From" variant="outlined" size="small" placeholder="Enter sender name" />
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <TextField fullWidth label="Bill To" variant="outlined" size="small" placeholder="Enter recipient name" />
                    </Grid>

                    <Grid item xs={12} md={6}>
                        <TextField fullWidth label="From Address" multiline rows={3} variant="outlined" size="small" placeholder="Enter sender address" />
                    </Grid>
                    <Grid item xs={12} md={6}>
                        <TextField fullWidth label="Bill To Address" multiline rows={3} variant="outlined" size="small" placeholder="Enter recipient address" />
                    </Grid>
                </Grid>
